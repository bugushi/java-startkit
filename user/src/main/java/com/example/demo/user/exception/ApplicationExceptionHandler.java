...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public Result handleApplicationException(ApplicationException e) {
        return new Result(e.getApplicationStatus());
    }
    ...
    public Result handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return new Result(ApplicationStatus.PARAMETER_BIND_FAIL, list);
    }
    ...
    protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
        ...
        if (ex.hasErrors()) {
            ...
            Result result = new Result(ApplicationStatus.PARAMETER_BIND_FAIL, list);
